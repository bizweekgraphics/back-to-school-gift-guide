            	...
            	$('.video-embedded').each(function(){
            		...
            		if ( mobileDevice ) {
            			...
            			if ( $(this).hasClass('y') ) {
            				...
            				$(this).append('<iframe id="vmPlayer" src="../index_files/' + $(this).data('src').replace('autoplay=1', 'autoplay=0') + '" width="100%" height="100%" webkitAllowFullScreen mozallowfullscreen allowFullScreen frameborder="0"></iframe>');
         	...
         	setupProducts : function() {
				...
				if ( $('.woocommerce-ordering').length > 0 ){
					...
					$('.woocommerce-ordering').find('option').each(function(){
						sortWidgetDom += '<li><a href="../index_files/' + window.location.href.split('?')[0] + '?orderby=' + $(this).val() + '">' + $(this).text() + '</a></li>';
					});
